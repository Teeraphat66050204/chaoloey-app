...
class DateTimePickerDialog(
    ...
    private val blockedDates: Set<String> = emptySet(),
        ...
        binding.doneButton.setOnClickListener {
            ...
            val selected = Calendar.getInstance().apply {
                ...
                set(
                    ...
                    else if (amPm == "am" && selectedHour == 12) 0
                    else selectedHour
                )
    ...
    private fun setupTimeSelection() {
        binding.hourPickerEdit.setText(
            String.format(Locale.US, "%02d", selectedHour % 12).takeIf { it != "00" } ?: "12"
        )
    ...
    private fun setupCalendar() {
        ...
        binding.calendarView.setDate(
            currentCalendar.timeInMillis.coerceAtLeast(tomorrow.timeInMillis), false, false
        )
